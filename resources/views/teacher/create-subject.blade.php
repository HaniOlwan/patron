            ...
            <div class="col ">
                <form action="create-subject" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="subject_title" value="title" id="Subject-title" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="subject_description" id="Subject-description" required>descriptipn</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
