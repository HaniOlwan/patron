                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td scope="col"><a href="/admin/subject/{{$subject->id}}/students">{{ $subject->students->count() }}</a></td>
                            <td scope="col"><a href="/admin/subject/{{$subject->id}}/participants">{{ $subject->teachers->count() }}</a></td>
